...
![InserDWG]({{ "/assets/2014/07/InserDWG.jpg" | absolute_url }})
...
![ManageStartingView]({{ "/assets/2014/07/ManageStartingView.jpg" | absolute_url }})

I generally use a Drafting View to display a handful of information about the opened model.

![StartingView]({{ "/assets/2014/07/StartingView.jpg" | absolute_url }})
